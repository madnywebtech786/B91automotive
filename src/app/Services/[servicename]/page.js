...
const services = [
  {
    ...
    img: "/images/Engine & Transmission Diagnostics and Repairs.webp",
    features: [
    ...
    additionalInfo:
      "Ignoring early signs of engine or transmission failure can lead to costly repairs. If you notice strange noises, sluggish acceleration, slipping gears, or the check engine light, bring your vehicle in for a detailed inspection.",
  },
  {
    id: 2,
    ...
    img: "/images/Autobody & Paint Services.webp",
    features: [
    ...
    additionalInfo:
      "By choosing B91 Automotic, you can be assured that your car’s structural integrity and appearance are in expert hands. Our services help maintain resale value, prevent rusting, and enhance your vehicle’s overall appeal.",
  },
  {
    id: 3,
    ...
    img: "/images/Insurance Claims Assistance.webp",
    features: [
    ...
    additionalInfo:
      "We understand that dealing with insurance claims can be overwhelming, which is why we make it as stress-free as possible. Our team ensures accurate claim processing, so you never have to worry about unexpected costs or unnecessary delays.",
  },
  {
    id: 4,
    ...
    img: "/images/Windshield Replacement & Repair.webp",
    features: [
    ...
    additionalInfo:
      "Driving with a compromised windshield can increase the risk of accidents, airbag malfunction, and structural collapse in a collision. Our quick and efficient repair process restores your windshield’s strength, ensuring a clear and safe driving experience.",
  },
  {
    id: 5,
    ...
    img: "/images/New & Used Automotive Parts.webp",
    features: [
    ...
    additionalInfo:
      "Buying from B91 Automotic means you get cost-effective solutions without compromising on quality or safety. We help you find the right part for your make and model, ensuring a perfect fit and long-lasting performance.",
  },
  {
    id: 6,
    ...
    img: "/images/New & Used Autobody Parts.webp",
    features: [
    ...
    additionalInfo:
      "By offering both new and used options, we help customers find the best autobody parts within their budget. Our team ensures all parts are fully inspected and in great condition, so you can make your repairs with confidence.",
  },
];
